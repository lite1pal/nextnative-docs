...
Then follow the [Preparing for deployment](../preparing-for-deployment/rename-your-app) guide.
...
1. **Clean the Project:** Menu → Build → Clean Project (removes stale build files)
2. **Invalidate Caches and Restart:** Menu → File → Invalidate Caches → Click **🟦 Invalidate and Restart**
